...
<html lang="en">
    ...
    <body>
        ...
        <div class="container center-block row">
            ...
            <div class="col-md-12">
                <h1 class="form-signin-heading" style="text-align:center;padding:0 0 20px 0;"><strong>BEACHBOOKS<strong> Privacy Policy</h1>
            </div>
            <div class="col-md-12" style="overflow:auto; height:500px;">
                <h3 style="text-align:center; font-size:30px;">U.S. Terms of Use</h3>
